...
| `decision` | 68 | 0 | 68 | 0 | 68 | 68 | 68 | 68 |
| `decision` | 17 | 0 | 17 | 0 | 17 | 17 | 17 | 17 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 57 | 57 | 57 | 57 | 57 | 57 | 0 | 57 |
| `probe_skip` | 68 | 68 | 68 | 68 | 68 | 68 | 0 | 68 |
...
- `ab_record_id`: `{"artifacts_with_rows": 6, "common_values": 1, "per_artifact_values": [1, 68, 17, 1, 1, 1]}`
...
- `pool_id`: `{"artifacts_with_rows": 6, "common_values": 0, "per_artifact_values": [1, 68, 17, 1, 1, 0]}`
- `mint`: `{"artifacts_with_rows": 6, "common_values": 1, "per_artifact_values": [1, 68, 17, 1, 1, 1]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 57, "per_artifact_values": [57]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 57, "per_artifact_values": [57]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 57, "per_artifact_values": [57]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 57, "per_artifact_values": [57]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 57, "per_artifact_values": [57]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 57, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 57, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 57, "joined_to_decision_with_v3_payload": 57, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 16}, "policy_hash_match": 57, "policy_hash_mismatch": 0, "rows": 57, "rows_with_ab_record_id": 57, "unmatched_rows": 0}`
