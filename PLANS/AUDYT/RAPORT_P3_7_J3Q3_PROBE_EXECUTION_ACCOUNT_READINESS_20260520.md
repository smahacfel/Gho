...
- probe_selection: `/root/Gho/logs/shadow_run/shadow-burnin-v3-p37-counterfactual-probe-r15-smoke-r8m/probe_selection.jsonl`
- probe_skips: `/root/Gho/logs/shadow_run/shadow-burnin-v3-p37-counterfactual-probe-r15-smoke-r8m/probe_skips.jsonl`
- decision_root: `/root/Gho/logs/rollout/shadow-burnin-v3-p37-counterfactual-probe-r15-smoke-r8m/decisions`
...
classifications = {'unknown': 11, 'missing_execution_route_identity': 1}
```
...
| --- | --- | --- | --- | --- | ---: | --- |
| `ae947b75cc` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `c8ef2da398` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `826a7bfecd` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `7eec40b709` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `5540ebad88` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `b474de4c1c` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `fc37679879` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `ea829cdb69` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `afb6de4b26` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `24d605da59` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `7dc032d7b3` | `none` | `unknown` | `none` | `exact` | 0 | `none` |
| `a3ef649f29` | `none` | `missing_execution_route_identity` | `none` | `exact` | 0 | `missing_execution_route_identity` |
