...
- decision_rows_with_ab_record_id: `1279`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 1080 | 0 | 1080 | 0 | 1080 | 1080 | 1080 | 1080 |
| `decision` | 199 | 0 | 199 | 0 | 199 | 199 | 199 | 199 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 548 | 548 | 548 | 548 | 548 | 548 | 0 | 548 |
| `probe_skip` | 1079 | 1079 | 1079 | 1079 | 1079 | 1079 | 0 | 1079 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 199, "per_artifact_values": [1080, 199]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 199, "per_artifact_values": [1080, 199]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 199, "per_artifact_values": [1080, 199]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 548, "per_artifact_values": [548]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 548, "per_artifact_values": [548]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 548, "per_artifact_values": [548]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 548, "per_artifact_values": [548]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 548, "per_artifact_values": [548]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 548, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 548, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 548, "joined_to_decision_with_v3_payload": 548, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 142}, "policy_hash_match": 548, "policy_hash_mismatch": 0, "rows": 548, "rows_with_ab_record_id": 548, "unmatched_rows": 0}`
