...
- decision_rows_with_ab_record_id: `535`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 419 | 0 | 419 | 0 | 419 | 419 | 419 | 419 |
| `decision` | 116 | 0 | 116 | 0 | 116 | 116 | 116 | 116 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 5 | 5 | 5 | 5 | 5 | 5 | 0 | 5 |
| `probe_skip` | 419 | 419 | 419 | 419 | 419 | 419 | 0 | 419 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 116, "per_artifact_values": [419, 116]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 116, "per_artifact_values": [419, 116]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 116, "per_artifact_values": [419, 116]}`
