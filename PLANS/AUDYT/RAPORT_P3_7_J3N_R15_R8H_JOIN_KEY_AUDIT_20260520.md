...
- decision_rows_with_ab_record_id: `20`
...
| `probe_selection` | 8 | 8 | 8 | 8 | 8 | 8 | 0 | 8 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 6, "per_artifact_values": [14, 6]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 6, "per_artifact_values": [14, 6]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 6, "per_artifact_values": [14, 6]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 8, "per_artifact_values": [8]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 8, "per_artifact_values": [8]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 8, "per_artifact_values": [8]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 8, "per_artifact_values": [8]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 8, "per_artifact_values": [8]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 8, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 8, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 8, "joined_to_decision_with_v3_payload": 8, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 6}, "policy_hash_match": 8, "policy_hash_mismatch": 0, "rows": 8, "rows_with_ab_record_id": 8, "unmatched_rows": 0}`
