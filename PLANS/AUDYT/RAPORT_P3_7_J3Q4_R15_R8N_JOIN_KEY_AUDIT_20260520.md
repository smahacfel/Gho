...
- decision_rows_with_ab_record_id: `27`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 25 | 0 | 25 | 0 | 25 | 25 | 25 | 25 |
| `decision` | 2 | 0 | 2 | 0 | 2 | 2 | 2 | 2 |
| `probe_entry` | 5 | 5 | 5 | 5 | 5 | 5 | 0 | 5 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 17 | 17 | 17 | 17 | 17 | 17 | 0 | 17 |
| `probe_skip` | 20 | 20 | 20 | 20 | 20 | 20 | 0 | 20 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [25, 2]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [25, 2]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [25, 2]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 17, 5]}`
- `probe_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 17, 5]}`
- `candidate_id`: `{"artifacts_with_rows": 3, "common_values": 0, "per_artifact_values": [5, 17, 5]}`
- `pool_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 17, 5]}`
- `mint`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 17, 5]}`

## Probe Decision Join

- decision_join_acceptance: `pass`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 17, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 17, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 17, "joined_to_decision_with_v3_payload": 17, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 2}, "policy_hash_match": 17, "policy_hash_mismatch": 0, "rows": 17, "rows_with_ab_record_id": 17, "unmatched_rows": 0}`
