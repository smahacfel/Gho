...
- config: `/root/Gho/configs/rollout/shadow-burnin-v3-p37-mfs-lifecycle-r14-j1-smoke.toml`
- readiness: `not_ready`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 496 | 0 | 496 | 496 | 496 | 496 | 496 |
| `decision` | 96 | 0 | 96 | 96 | 96 | 96 | 96 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 96, "per_artifact_values": [496, 96]}`
- `candidate_id`: `{"artifacts_with_rows": 2, "common_values": 0, "per_artifact_values": [0, 0]}`
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 96, "per_artifact_values": [496, 96]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 96, "per_artifact_values": [496, 96]}`
