...
- decision_rows_with_ab_record_id: `22`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 21 | 0 | 21 | 0 | 21 | 21 | 21 | 21 |
| `decision` | 1 | 0 | 1 | 0 | 1 | 1 | 1 | 1 |
| `probe_entry` | 5 | 5 | 5 | 5 | 5 | 5 | 0 | 5 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 21 | 21 | 21 | 21 | 21 | 21 | 0 | 21 |
| `probe_skip` | 16 | 16 | 16 | 16 | 16 | 16 | 0 | 16 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [21, 1]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [21, 1]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [21, 1]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 21, 5]}`
- `probe_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 21, 5]}`
- `candidate_id`: `{"artifacts_with_rows": 3, "common_values": 0, "per_artifact_values": [5, 21, 5]}`
- `pool_id`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 21, 5]}`
- `mint`: `{"artifacts_with_rows": 3, "common_values": 5, "per_artifact_values": [5, 21, 5]}`

## Probe Decision Join

- decision_join_acceptance: `pass`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 21, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 21, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 21, "joined_to_decision_with_v3_payload": 21, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 1}, "policy_hash_match": 21, "policy_hash_mismatch": 0, "rows": 21, "rows_with_ab_record_id": 21, "unmatched_rows": 0}`
