...
| --- | --- | --- | --- | --- | --- | --- |
| `da5fd88504` | `creator_vault` | `builder_required_account_not_in_mfs` | `strict_required_account_missing_without_diag_evidence` | `False` | `not_built_pre_route_precheck` | `execution_account_readiness_materialization` |
