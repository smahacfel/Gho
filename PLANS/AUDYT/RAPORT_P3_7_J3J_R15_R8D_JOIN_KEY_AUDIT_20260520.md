...
- decision_rows_with_ab_record_id: `39`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 34 | 0 | 34 | 0 | 34 | 34 | 34 | 34 |
| `decision` | 5 | 0 | 5 | 0 | 5 | 5 | 5 | 5 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 25 | 25 | 25 | 25 | 25 | 25 | 0 | 25 |
| `probe_skip` | 30 | 30 | 30 | 30 | 30 | 30 | 0 | 30 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 5, "per_artifact_values": [34, 5]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 5, "per_artifact_values": [34, 5]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 5, "per_artifact_values": [34, 5]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 25, "per_artifact_values": [25]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 25, "per_artifact_values": [25]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 25, "per_artifact_values": [25]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 25, "per_artifact_values": [25]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 25, "per_artifact_values": [25]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 25, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 25, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 25, "joined_to_decision_with_v3_payload": 25, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 5}, "policy_hash_match": 25, "policy_hash_mismatch": 0, "rows": 25, "rows_with_ab_record_id": 25, "unmatched_rows": 0}`
