...
- config: `/root/Gho/configs/rollout/shadow-burnin-v3-p37-counterfactual-probe-r15-smoke-r8m.toml`
- readiness: `not_ready`
...
| `probe_selection` | 11 | 11 | 11 | 11 | 11 | 11 | 0 | 11 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [19, 2]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [19, 2]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 2, "per_artifact_values": [19, 2]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 3, "common_values": 4, "per_artifact_values": [4, 11, 4]}`
- `probe_id`: `{"artifacts_with_rows": 3, "common_values": 4, "per_artifact_values": [4, 11, 4]}`
- `candidate_id`: `{"artifacts_with_rows": 3, "common_values": 0, "per_artifact_values": [4, 11, 4]}`
- `pool_id`: `{"artifacts_with_rows": 3, "common_values": 4, "per_artifact_values": [4, 11, 4]}`
- `mint`: `{"artifacts_with_rows": 3, "common_values": 4, "per_artifact_values": [4, 11, 4]}`

## Probe Decision Join

- decision_join_acceptance: `pass`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 11, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 11, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 11, "joined_to_decision_with_v3_payload": 11, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 2}, "policy_hash_match": 11, "policy_hash_mismatch": 0, "rows": 11, "rows_with_ab_record_id": 11, "unmatched_rows": 0}`
