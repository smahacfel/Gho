...
- decision_rows_with_ab_record_id: `745`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 576 | 0 | 576 | 0 | 576 | 576 | 576 | 576 |
| `decision` | 169 | 0 | 169 | 0 | 169 | 169 | 169 | 169 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 5 | 5 | 5 | 5 | 5 | 5 | 0 | 5 |
| `probe_skip` | 576 | 576 | 576 | 576 | 576 | 576 | 0 | 576 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 169, "per_artifact_values": [576, 169]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 169, "per_artifact_values": [576, 169]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 169, "per_artifact_values": [576, 169]}`
...
- `probe_selection`: `{"exact_decision_v3_join": 5, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 5, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 5, "joined_to_decision_with_v3_payload": 5, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 3}, "policy_hash_match": 5, "policy_hash_mismatch": 0, "rows": 5, "rows_with_ab_record_id": 5, "unmatched_rows": 0}`
