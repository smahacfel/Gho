...
- decision_rows_with_ab_record_id: `15`
...
| `probe_skip` | 13 | 13 | 13 | 13 | 13 | 13 | 0 | 13 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [14, 1]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [14, 1]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 1, "per_artifact_values": [14, 1]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 11, "per_artifact_values": [11]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 11, "per_artifact_values": [11]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 11, "per_artifact_values": [11]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 11, "per_artifact_values": [11]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 11, "per_artifact_values": [11]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 11, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 11, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 11, "joined_to_decision_with_v3_payload": 11, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 1}, "policy_hash_match": 11, "policy_hash_mismatch": 0, "rows": 11, "rows_with_ab_record_id": 11, "unmatched_rows": 0}`
