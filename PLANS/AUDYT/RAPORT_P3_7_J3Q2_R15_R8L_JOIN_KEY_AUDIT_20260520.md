...
| `decision` | 3 | 0 | 3 | 0 | 3 | 3 | 3 | 3 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 20 | 20 | 20 | 20 | 20 | 20 | 0 | 20 |
| `probe_skip` | 19 | 19 | 19 | 19 | 19 | 19 | 0 | 19 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 3, "per_artifact_values": [20, 3]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 3, "per_artifact_values": [20, 3]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 3, "per_artifact_values": [20, 3]}`

## Probe Artifact Intersections

- `ab_record_id`: `{"artifacts_with_rows": 1, "common_values": 20, "per_artifact_values": [20]}`
- `probe_id`: `{"artifacts_with_rows": 1, "common_values": 20, "per_artifact_values": [20]}`
- `candidate_id`: `{"artifacts_with_rows": 1, "common_values": 20, "per_artifact_values": [20]}`
- `pool_id`: `{"artifacts_with_rows": 1, "common_values": 20, "per_artifact_values": [20]}`
- `mint`: `{"artifacts_with_rows": 1, "common_values": 20, "per_artifact_values": [20]}`

## Probe Decision Join

- decision_join_acceptance: `fail`
- required_exact_decision_v3_join_coverage: `1.0`
- `probe_selection`: `{"exact_decision_v3_join": 20, "exact_decision_v3_join_coverage": 1.0, "feature_hash_match": 20, "feature_hash_mismatch": 0, "joined_to_decision_by_ab_record_id": 20, "joined_to_decision_with_v3_payload": 20, "mismatch_reasons": {"multiple_decision_rows_for_ab_record_id": 3}, "policy_hash_match": 20, "policy_hash_mismatch": 0, "rows": 20, "rows_with_ab_record_id": 20, "unmatched_rows": 0}`
