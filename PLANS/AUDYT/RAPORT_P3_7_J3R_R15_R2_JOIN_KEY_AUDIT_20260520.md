...
- decision_rows_with_ab_record_id: `542`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `decision` | 463 | 0 | 463 | 0 | 463 | 463 | 463 | 463 |
| `decision` | 79 | 0 | 79 | 0 | 79 | 79 | 79 | 79 |
| `probe_entry` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_lifecycle` | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `probe_selection` | 5 | 5 | 5 | 5 | 5 | 5 | 0 | 5 |
| `probe_skip` | 458 | 458 | 458 | 458 | 458 | 458 | 0 | 458 |
...
- `ab_record_id`: `{"artifacts_with_rows": 2, "common_values": 79, "per_artifact_values": [463, 79]}`
...
- `pool_id`: `{"artifacts_with_rows": 2, "common_values": 79, "per_artifact_values": [463, 79]}`
- `mint`: `{"artifacts_with_rows": 2, "common_values": 79, "per_artifact_values": [463, 79]}`
...
- `probe_selection`: `{"exact_decision_v3_join": 1, "exact_decision_v3_join_coverage": 0.2, "feature_hash_match": 1, "feature_hash_mismatch": 4, "joined_to_decision_by_ab_record_id": 5, "joined_to_decision_with_v3_payload": 5, "mismatch_reasons": {"feature_hash_mismatch": 4, "multiple_decision_rows_for_ab_record_id": 1}, "policy_hash_match": 5, "policy_hash_mismatch": 0, "rows": 5, "rows_with_ab_record_id": 5, "unmatched_rows": 0}`
- `probe_transport`: `{"exact_decision_v3_join": 1, "exact_decision_v3_join_coverage": 0.2, "feature_hash_match": 1, "feature_hash_mismatch": 4, "joined_to_decision_by_ab_record_id": 5, "joined_to_decision_with_v3_payload": 5, "mismatch_reasons": {"feature_hash_mismatch": 4, "multiple_decision_rows_for_ab_record_id": 1}, "policy_hash_match": 5, "policy_hash_mismatch": 0, "rows": 5, "rows_with_ab_record_id": 5, "unmatched_rows": 0}`
