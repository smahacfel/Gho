...
Status: `ACCEPTED / BASELINE_RECONCILIATION_PASS / DOCUMENTATION_ONLY`
...
## 3. Najważniejsze rozstrzygnięcia baseline
...
## 5. Anty-post-hoc i burn-in freeze
...
## 6. Konsekwencje dla kolejnych PR-ów

PR1 może rozpocząć się od registry/profile/status foundation. Musi adaptować
istniejące top3/FSC/status surfaces, a nie je dublować.
...
Nie zmieniono Rust, Python, TOML, testów, aktywnego runa ani istniejących
artefaktów użytkownika.
