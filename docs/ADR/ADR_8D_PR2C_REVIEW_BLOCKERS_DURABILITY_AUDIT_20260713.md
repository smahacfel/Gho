...
Jeden production timer składa się z:

```text
PR2B frozen producer inputs
...
Filesystem I/O, queue wait i backpressure pozostają osobnymi metrykami.
...
- `BURN_IN_CONTRACT_V1` version i canonical hash;
...
- terminal pair construction p50/p95/p99: `416 / 629 / 794 us`;
- final serialization p50/p95/p99: `49 / 75 / 94 us`;
- comparator p50/p95/p99: `7 / 19 / 52 us`;
- Wire V1 p95/max: `2 339 / 2 339 B`;
- sidecar p95/p99: `21 486 / 21 486 B`;
- v34 p95: `1 176 B`.

Autoryzowany amendment z 2026-07-13 podniósł pełny build+serialize i projection
build/validate z 1 ms do 5 ms p99. Comparator, final serialization i logger
enqueue pozostają ograniczone do 1 ms. Timer nie został skrócony ani
przesunięty za producer boundary.
