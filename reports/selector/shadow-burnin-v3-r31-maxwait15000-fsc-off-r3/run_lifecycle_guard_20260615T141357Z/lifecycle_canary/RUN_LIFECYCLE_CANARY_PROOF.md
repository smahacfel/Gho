...
- phase: `lifecycle`
- scope: `shadow-burnin-v3-r31-maxwait15000-fsc-off-r3`
- config: `/root/Gho/configs/rollout/shadow-burnin-v3-r31-maxwait15000-fsc-off.toml`

## Event Canary

- status: `PASS`
- event_delta: `{"Candidate": 86, "NewPoolDetected": 253, "PoolTransaction": 7914}`
- bad_event_json_delta: `0`
- diag_account_update_relay_delta: `15820`
